...
const George = new President('George Washington');

const Abraham = new President('Abraham Lincoln');

const Richard = new President('Richard Nixon');

const Jimmy = new President('Jimmy Carter');
